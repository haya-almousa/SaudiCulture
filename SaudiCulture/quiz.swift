...
//    
//    init(region: RegionType, startIndex: Int = 0) {
//        self.region = region
...
//    func nextPuzzle() {
//
//        currentIndex = (currentIndex + 1) % activePuzzles.count
//        selectedIndex = nil
//        feedback = ""
//    }
//
...
//
//#Preview {
//    PuzzleChoicesView(region: .central, startIndex: 0)
//}
...
struct PuzzleChoicesView: View {
    ...
    func hintPopupView() -> some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                Text(activePuzzles[flow.currentLevel].hint)
                    .font(.custom("Saudi-Regular", size: 22))
                    .foregroundColor(Color(hex: "FCF0DD"))
                    .multilineTextAlignment(.center)
